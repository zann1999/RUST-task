...
impl Package {
    ...
    fn is_international(&self) -> String {
        // Something goes here...
        self.recipient_country.to_string()
    }
...
////////// assert!(package.is_international()); //cannot apply unary operator `!` to type string : em chưa hiểu lỗi này và cách fix
    }
