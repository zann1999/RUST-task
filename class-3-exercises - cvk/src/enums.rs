...
mod tests {
    ...
    fn exercise3_should_work() {
        assert_eq!(Direction::North.opposite(), "South");
        assert_eq!(Direction::East.opposite(), "West");
        assert_eq!(Direction::South.opposite(), "North");
        assert_eq!(Direction::West.opposite(), "East");
    }
